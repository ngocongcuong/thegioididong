				...
				<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
				  <div class="carousel-inner">
				    <div class="carousel-item active">
				      <img class="d-block w-100" src="<?php echo $img_slider[0]['img_link']; ?>" alt="First slide">
				    </div>
				    <?php 
				    	for ($i=1; $i < count($img_slider); $i++) { 
				    ?>
				    <div class="carousel-item">
				      <img class="d-block w-100" src="<?php echo $img_slider[$i]['img_link']; ?>" alt="Second slide">
				    </div>
				  	<?php } ?>
				  </div>
